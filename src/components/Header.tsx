        ...
        <div className="px-2 pt-2 pb-1 lg:p-0 xl:max-w-[1200px] m-auto grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className=" flex justify-between items-center">
                ...
                <ul className="p-1 flex gap-x-1 md:gap-x-5 lg:gap-x-10 text-sm lg:text-base font-semibold uppercase">
                    <a 
                        className={`${ activeSection === "sobremi" ? "text-white dark:text-slate-100 border-b-2 border-black dark:border-slate-200 scale-105 transition-colors" : "text-gray-300 dark:text-slate-500 transition-colors"
                    ...
                    <a 
                        className={`${ activeSection === "experiencia" ? "text-white dark:text-slate-100 border-b-2 border-black dark:border-slate-200 scale-105 transition-colors" : "text-gray-300 dark:text-slate-500 transition-colors"
                          } p-2 hover:cursor-pointer hover:scale-105 transition-transform duration-300 ease-in-out`}
                        href='#experiencia'
                    ...
                    <a 
                        className={`${ activeSection === "proyectos" ? "text-white dark:text-slate-100 border-b-2 border-black dark:border-slate-200 scale-105 transition-colors" : "text-gray-300 dark:text-slate-500 transition-colors"
                        } p-2 hover:cursor-pointer hover:scale-105 transition-transform duration-300 ease-in-out`}
                        href='#proyectos'
