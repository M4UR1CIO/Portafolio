...
export default function Modal({isOpen, setIsOpen} : ModalProps) {
  ...
  return (
    ...
    >
        ...
        <div
            className={`bg-gradient-to-t from-slate-900 to-slate-800 rounded-lg max-w-[40vh] md:max-w-2xl max-h-[80vh] overflow-y-auto no-scrollbar transform transition-all duration-500 ${
                isOpen ? "scale-100 translate-y-0" : "scale-75 translate-y-10"
            }`}
        >
            <div className='z-10 sticky top-0 bg-gradient-to-b from-slate-900 to-slate-800 rounded-b-md py-3 px-3 lg:px-6 flex items-center justify-between'>
            ...
            <ul className="mt-4 space-y-6 px-1 lg:px-3 mb-4 group/list">
                <li className="group relative lg:hover:bg-slate-700/35 border border-transparent hover:border-steal-800 rounded-lg lg:hover:shadow-md lg:hover:shadow-slate-700 transition-all duration-300 ease-in-out lg:hover:!opacity-100 lg:group-hover/list:opacity-30">
                    ...
                    <div className='grid md:grid-cols-8 gap-x-4 items-center p-3'>
                        ...
                        <div className="md:col-span-4">
                            <img 
                                ...
                                className="border-2 border-transparent group-hover:border-slate-200 rounded-lg transition-all duration-300 ease-in-out"
                            />
                        </div>
                    </div>
                    ...
                    <div className='grid grid-cols-2 md:grid-cols-8 gap-x-4 items-center p-3'>
                        <div className="col-span-1 md:col-span-2 order-2 md:order-1">
                            <img 
                                ...
                                alt="Guia de Uso"
                                className="w-full h-auto border-2 border-transparent group-hover:border-slate-200 rounded-lg transition-all duration-300 ease-in-out"
                            />
                        </div>
                        ...
                        <div className="col-span-2 md:col-span-4 order-1 md:order-3 mb-2 md:md-0">
                            <p className="text-slate-300 text-sm text-justify">Interactúa con un chatbot inteligente que brinda informacion acerca de la plataforma de Metricas, ademas de redirifir a las secciones correspondientes de la plataforma.</p>
                        </div>
                    </div>
                </li>
