...
export default function PrimerColumna() {
  return (
    <>
        ...
        <div className="pr-3 pl-3 bg-white dark:bg-slate-900 lg:fixed top-24 lg:top-24 lg:h-5/6 flex flex-col justify-between transition-colors">
            <div className='max-w-[500px]'>
                ...
                <motion.h3
                    ...
                    >
                        ...
                        <p>Técnico en Ingeniería de Software con IA</p>
                </motion.h3>
                ...
                >
                    Desarrollo de software, análisis de datos y optimización de procesos mediante soluciones tecnológicas.
                </motion.p>
                ...
                <div className='mt-12 md:mt-20'>
                    ...
                    >
                        ...
                        <li
                            className='flex items-center gap-x-3 group max-w-[330px] p-2 cursor-pointer border border-transparent dark:hover:border-slate-800 hover:shadow-lg hover:shadow-slate-500 transition-shadow duration-500 ease-in-out rounded-md hover:text-gray-900 dark:hover:text-slate-100' 
                            onClick={() => window.open("https://drive.google.com/file/d/14qHKbBN-2p0sxOW0OqlnWkLKEIHlgy74/view?usp=sharing", "_blank")}
                        >
